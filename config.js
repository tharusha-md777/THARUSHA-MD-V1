...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "THARUSHA-MD=OoRTSLrZ#N88Rltf2A2PUCIYxLgY4iuNL_UL_PtbvVjWPrss1Pxk",// add your Session Id 
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`🔗 𝐘𝐎𝐔𝐑 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐄𝐄𝐍𝐄𝐃 𝐁𝐘 𝐓𝐇𝐀𝐑𝐔𝐒𝐇𝐀-𝐌𝐃 🇱🇰`*",// set the auto reply massage on status reply  
...
MENTION_REPLY: process.env.MENTION_REPLY || "false",// make true if want auto voice reply if someone menetion you 
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/ir3kxt.jpg",// add custom menu and mention reply image url
MENU_IMG: process.env.MENU_IMG || "https://files.catbox.moe/ir3kxt.jpg",
PREFIX: process.env.PREFIX || ".",// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "THARUSHA-MD",// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "THARUSHA-MD",// type sticker pack name 
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",// make this true for custum emoji react    
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",// chose custom react emojis by yourself 
DELETE_LINKS: process.env.DELETE_LINKS || "false",// automatic delete links witho remove member 
OWNER_NUMBER: process.env.OWNER_NUMBER || "94740326138",// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "𝐓𝐇𝐀𝐑𝐔𝐒𝐇𝐀 𝐒𝐀𝐍𝐃𝐈𝐏𝐀",// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*㋛ 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝚃𝙷𝙰𝚁𝚄𝚂𝙷𝙰  〽️Ｄ*",// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/k0rkb4.jpg",// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> i'm alive now *THARUSHA-MD*⚡",// add alive msg here 
...
AUTO_TYPING: process.env.AUTO_TYPING || "true",// true for automatic show typing   
READ_CMD: process.env.READ_CMD || "false",// true if want mark commands as read 
DEV: process.env.DEV || "94740326138",//replace with your whatsapp number        
ANTI_VV: process.env.ANTI_VV || "true",// true for anti once view 
ANTI_DEL_PATH: process.env.ANTI_DEL_PATH || "log", // change it to 'same' if you want to resend deleted message in same chat 
AUTO_RECORDING: process.env.AUTO_RECORDING || "false",// make it true for auto recoding 
OWNER_IMG_URL:process.env.OWNER_IMG_URL || "https://i.ibb.co/Z49zN2D/SulaMd.jpg" // put your img url 
};
